...
struct RecommendPrompt {
    ...
    func goalPrompt(entity: UserEntity) -> String {
        ...
        중요1: 반드시 하루동안 달성할 수 있는 다양한 목표 생성  ex) 1,000kcal 태우기, 10,000보 걷기 등
    ...
    func quoteOfTheDayPrompt(entity: UserEntity) -> String {
        ...
        위 사용자 정보를 바탕으로 분석하여 간략한 한 문장의 추천 글귀, 동기부여가되는 한마디 말, 문장, 명언 등의 한 문장을 생성해주세요.
        중요1: 반드시 간단한 한 문장
    ...
    func weatherPrompt(entity: UserEntity, currentWeather: WeatherItem) -> String {
        ...
        중요2: description 첫번째 문장 마침표(.)와 다음 문장 사이에 \n포함
        중요3: 반드시 아래와 같은 JSON형식으로 생성해야 하며, 다른 텍스트는 반드시 포함되지 않아야 합니다. 
    ...
    func videoPrompt(entity: UserEntity) -> String {
        ...
        중요2: 각 검색어는 한 단어로 생성해야 됩니다.
        중요3: 반드시 아래와 같은 형식으로 생성해야 합니다.
